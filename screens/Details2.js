...
import { COLORS, LIGHT_BLUE } from '../COLORS.js';
...
export default class DetailsScreen extends React.Component {
    ...
    static navigationOptions = ({ navigation }) => {
        return {
            headerTitle: <Topbar text="Artist" isCenter={true} />,
            ...
            payload => {
                ...
                if (payload.action.type == "Navigation/JUMP_TO") {
                    ...
                    const resetAction = StackActions.reset({
                        ...
                        actions: [NavigationActions.navigate({ routeName: 'Artist' })],
                    });
    ...
    render() {
        ...
        return (
            <ScrollView style={styles.scrollView}>
                ...
                <Text>  </Text>
                {/* Title */}
                <Text style={[styles.title, { color: LIGHT_BLUE }]}>{this.getParam("name", "Title")}</Text>
                <View style={styles.bottom}>
                    {/* Artist and Year*/}
                    <View>
                        <Text style={styles.artist}>{this.getParam("pieces", "Pieces")}</Text>
                    </View>
                    <Text></Text>
                    <View>
