        ...
        return (
          <TouchableHighlight style={styles.touchable}
            ...
            <ImageBackground style={{borderRadius:100, height: 200, width:"100%", marginTop:10}}  imageStyle={{ borderRadius: 10, width:"100%"}} source={{uri: this.props.image}}>
              ...
              > 
              <Text style={{textAlign: "left", fontFamily: "aktiv-grotesk-regular", color:"white", textTransform: "uppercase", fontSize: 25, marginTop:-10, marginLeft:-9}}> {truncate(this.props.name,20)} </Text>
